...
const iModel = core_backend_1.StandaloneDb.openFile("/app/imodels/empty.bim", core_backend_2.OpenMode.Readonly);
...
iModel.withPreparedStatement(`SELECT ECInstanceId, Model, CodeValue, Parent  FROM bis.Element
`, (stmt) => {
